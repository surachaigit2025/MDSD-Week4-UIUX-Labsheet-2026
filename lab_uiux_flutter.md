...
Requirements:
- Circular avatar with a 64 logical-pixel diameter
...
2. เลือก **"Flutter"**
3. จะได้ไฟล์ `theme.dart` ที่มี `ColorScheme` สำหรับ Light และ Dark
...
> **คำถาม:** Primary, On Primary, Primary Containner, On Primary Containner คืออะไร มีลักษณะความสัมพันธ์ของสีอย่างไร? 
```text
ตอบคำถามที่นี่
```
---
